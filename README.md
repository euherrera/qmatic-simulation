...
2. npm install
3. npm run dev
4. http://localhost:3000/stores/0144/shipments?query=INSTORE0080
place existing store name and valid query param
5. open swagger interface on localhost:3000/docs in your browser
6. get all users from mongo using SwaggerUI as USER -> GET -> /user -> TryItOut -> Execute
